...
if($_GET[type]=="mcb" && $iw[mcb]!=1) alert(national_language($iw[language],"a0035","잘못된 접근입니다."),"");
if($_GET[type]=="publishing" && $iw[publishing]!=1) alert(national_language($iw[language],"a0035","잘못된 접근입니다."),"");
if($_GET[type]=="shop" && $iw[shop]!=1) alert(national_language($iw[language],"a0035","잘못된 접근입니다."),"");
if($_GET[type]=="doc" && $iw[doc]!=1) alert(national_language($iw[language],"a0035","잘못된 접근입니다."),"");
if($_GET[type]=="book" && $iw[book]!=1) alert(national_language($iw[language],"a0035","잘못된 접근입니다."),"");
