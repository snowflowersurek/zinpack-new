		...
		<div class="row">
			<div class="col-xs-12">
				<div class="table-header">
					"2015 골든커피어워드(GCA)" [원두콘테스트 부문]
				</div>
				<div class="space-4"></div>

			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="mail_form" name="mail_form" action="coffeentea_1_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select class="col-xs-12 col-sm-12" name="mail_01">
								...
								<option value="밀크베이스">밀크베이스</option>
								<option value="하우스브랜드">하우스브랜드</option>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">로스터기종</label>
						<div class="col-sm-8">
