			...
			when: {
				...
				missing: function (event, pages) {
					...
					for (var i = 0; i < pages.length; i++)
						addPage('<?=$path?>/page',pages[i], $(this));
	...
	$('.magazine-viewport').zoom({
		...
		when: {
			...
			resize: function(event, scale, page, pageElement) {
				...
				if (scale==1)
					loadSmallPage('<?=$path?>/page',page, pageElement);
				else
					loadLargePage('<?=$path?>/page',page, pageElement);
...
yepnope({
	...
	yep: ['magazine/lib/turn.min.js'],
	nope: ['magazine/lib/turn.html4.min.js', 'magazine/css/jquery.ui.html4.css'],
	both: ['magazine/lib/zoom.min.js', 'magazine/css/jquery.ui.css', 'magazine/js/magazine.js', 'magazine/css/magazine.css'],
	complete: loadApp
});
