...
$bmd_image = stripslashes($row['bmd_image']);
...
<div class="book_main_wrap" style="background-color:<?=$bn_color?>;">
	<div class="wrap">
		...
		<div class="text_title" style="color:<?=$bn_font?>;">
			<?=$bmd_type?>
		</div>
		<div class="text_reporter" style="color:<?=$bn_font?>;">
			<?=$bmd_image?>
		</div>
		<div class="text-view" style="border-top:1px solid <?=$bn_font?>;">
			<?=$content?>
		</div>
	</div>
</div>
