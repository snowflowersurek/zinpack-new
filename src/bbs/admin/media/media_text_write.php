...
<div class="page-content">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="bm_form" name="bm_form" action="<?=$iw['admin_path']?>/media/media_text_write_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post" enctype="multipart/form-data">
				<input type="hidden" name="bd_code" value="<?=$row['bd_code']?>" />
				<input type="hidden" name="upload_path" value="<?=$upload_path?>" />
				<input type="hidden" name="bm_type" value="3" />
				<input type="hidden" name="bmd_order" value="0" />
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-12" name="bmd_image">
							<span class="help-block col-xs-12">
								최대 30Byte 이하
							</span>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea name="bmd_content" class="col-xs-12 col-sm-12" style="height:300px;resize:none;"></textarea>
						</div>
					</div>
