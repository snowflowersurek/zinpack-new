...
<div class="page-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="gi_form" name="gi_form" action="<?=$iw['admin_path']?>/group_invite_edit_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post">
...
<script type="text/javascript">
	...
	function delete_invite(type ,ep, gp, idx)
    {
		if (confirm('초대정보를 삭제하시겠습니까?')) {
			location.href="group_invite_delete.php?type="+type+"&ep="+ep+"&gp="+gp+"&idx="+idx;
		}
    }
</script>
