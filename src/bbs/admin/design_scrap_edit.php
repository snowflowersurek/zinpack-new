...
$row = sql_fetch(" select * from $iw[home_scrap_table] where hs_no = '$_GET[menu]' and ep_code = '$iw[store]' and gp_code = '$iw[group]'");
if (!$row["hs_no"]) alert("잘못된 접근입니다!","");
$hs_no = $row['hs_no'];
$hm_code = $row['hm_code'];
$hs_scrap = $row['hs_scrap'];
$hs_name = str_replace("\'", '&#039;', $row['hs_name']);
$hs_name = str_replace('\"', '&quot;', $hs_name);
$hs_order = $row['hs_order'];
$hs_style = $row['hs_style'];
$hs_type = $row['hs_type'];
$hs_menu = $row['hs_menu'];
$hs_banner_cnt = $row['hs_banner_cnt'];
$hs_sort = $row['hs_sort'];
$hs_size_width = $row['hs_size_width'];
$hs_size_height = $row['hs_size_height'];
$hs_bg_color = $row['hs_bg_color'];
$hs_bg_alpha = $row['hs_bg_alpha'];
$hs_title_color = $row['hs_title_color'];
$hs_font_color = $row['hs_font_color'];
$hs_font_hover = $row['hs_font_hover'];
$hs_border_width = $row['hs_border_width'];
$hs_border_color = $row['hs_border_color'];
$hs_border_radius = $row['hs_border_radius'];
$hs_topic_type = $row['hs_topic_type'];
$hs_topic_link = $row['hs_topic_link'];
$hs_topic_more = $row['hs_topic_more'];
$hs_topic_bullet = $row['hs_topic_bullet'];
$hs_box_padding = $row['hs_box_padding'];
$hs_title = array();
$hs_title[0] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_1']));
$hs_title[1] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_2']));
$hs_title[2] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_3']));
$hs_title[3] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_4']));
$hs_title[4] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_5']));
$hs_title[5] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_6']));
$hs_title[6] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_7']));
$hs_title[7] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_8']));
$hs_title[8] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_9']));
$hs_title[9] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_10']));
$hs_title[10] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_11']));
$hs_title[11] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_12']));
$hs_title[12] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_13']));
$hs_title[13] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_14']));
$hs_title[14] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_15']));
$hs_title[15] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_16']));
$hs_title[16] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_17']));
$hs_title[17] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_18']));
$hs_title[18] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_19']));
$hs_title[19] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_20']));
$hs_title[20] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_title_21']));
$hs_content = array();
$hs_content[0] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_content_1']));
$hs_content[1] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_content_2']));
$hs_content[2] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_content_3']));
$hs_content[3] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_content_4']));
$hs_content[4] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_content_5']));
$hs_content[5] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_content_6']));
$hs_content[6] = str_replace('\"', '&quot;', str_replace("\'", '&#039;', $row['hs_content_7']));
$hs_link = array();
$hs_link[0] = $row['hs_link_1'];
$hs_link[1] = $row['hs_link_2'];
$hs_link[2] = $row['hs_link_3'];
$hs_link[3] = $row['hs_link_4'];
$hs_link[4] = $row['hs_link_5'];
$hs_link[5] = $row['hs_link_6'];
$hs_link[6] = $row['hs_link_7'];
$hs_link[7] = $row['hs_link_8'];
$hs_link[8] = $row['hs_link_9'];
$hs_link[9] = $row['hs_link_10'];
$hs_file = array();
$hs_file[0] = $row['hs_file_1'];
$hs_file[1] = $row['hs_file_2'];
$hs_file[2] = $row['hs_file_3'];
$hs_file[3] = $row['hs_file_4'];
$hs_file[4] = $row['hs_file_5'];
$hs_file[5] = $row['hs_file_6'];
$hs_file[6] = $row['hs_file_7'];
$hs_file[7] = $row['hs_file_8'];
$hs_file[8] = $row['hs_file_9'];
$hs_file[9] = $row['hs_file_10'];

$hs_sns_url = $row['hs_sns_url'];

$hs_file_sort = explode(",", $row['hs_file_sort']);
...
<div class="page-content">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="hs_form" name="hs_form" action="<?=$iw['admin_path']?>/design_scrap_edit_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post" enctype="multipart/form-data">
					<input type="hidden" name="upload_path" value="<?=$upload_path?>" />
					<input type="hidden" name="hs_scrap" value="<?=$hs_scrap?>" />
					<input type="hidden" name="hm_code" value="<?=$hm_code?>" />
					<input type="hidden" name="hs_no" value="<?=$hs_no?>" />
					<div class="form-group">
						<label class="col-sm-2 control-label">스크래퍼명</label>
						<div class="col-sm-8">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-12" name="hs_name" maxlength="125" value="<?=$hs_name?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" placeholder="입력" class="col-xs-2 col-sm-2" name="hs_box_padding" maxlength="2" value="<?=$hs_box_padding?>">px (0 ~ 99)
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div id="color_top" <?php if{?>style="display:none;"<?php }?>>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" placeholder="입력" class="col-xs-2 col-sm-2" name="hs_border_radius" maxlength="1" value="<?=$hs_border_radius?>">px (0 ~ 9)
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" placeholder="입력" class="col-xs-2 col-sm-2" name="hs_border_width" maxlength="1" value="<?=$hs_border_width?>">px (0 ~ 9)
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
								<input class="form-tooltip col-xs-3 col-sm-2" type="text" placeholder="#ffffff" data-toggle="tooltip" name="hs_border_color" maxlength="7" value="<?=$hs_border_color?>">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
								<input class="form-tooltip col-xs-3 col-sm-2" type="text" placeholder="#ffffff" data-toggle="tooltip" name="hs_bg_color" maxlength="7" value="<?=$hs_bg_color?>">
							</div>
						</div>
						<div class="space-4"></div>
					</div>
					...
					<div id="color_bottom" <?php if{?>style="display:none;"<?php }?>>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" placeholder="입력" class="col-xs-2 col-sm-2" name="hs_bg_alpha" maxlength="3" value="<?=$hs_bg_alpha?>">% (0 ~ 100)
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
								<input class="form-tooltip col-xs-3 col-sm-2" type="text" placeholder="#000000" data-toggle="tooltip" name="hs_title_color" maxlength="7" value="<?=$hs_title_color?>">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
								<input class="form-tooltip col-xs-3 col-sm-2" type="text" placeholder="#000000" data-toggle="tooltip" name="hs_font_color" maxlength="7" value="<?=$hs_font_color?>">
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
								<input class="form-tooltip col-xs-3 col-sm-2" type="text" placeholder="#000000" data-toggle="tooltip" name="hs_font_hover" maxlength="7" value="<?=$hs_font_hover?>">
							</div>
						</div>
					</div>
					...
					<div id="topic_default"<?php if{?>style="display:none;"<?php }?>>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" placeholder="입력" class="col-xs-8 col-sm-8" name="hs_topic_bullet" value="<?=$hs_topic_bullet?>" maxlength="100"> 최대 100글자
							</div>
						</div>
						<div class="space-4"></div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" placeholder="입력" class="col-xs-8 col-sm-8" name="hs_topic_more" value="<?=$hs_topic_more?>" maxlength="100"> 최대 100글자
							</div>
						</div>
						<div class="space-4"></div>
					</div>
					...
					<div id="custom_topic" <?php if{?>style="display:none;"<?php }?>>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" placeholder="입력" class="col-xs-12 col-sm-12" name="hs_topic_link" value="<?=$hs_topic_link?>" maxlength="255">
							</div>
						</div>
						<div class="space-4"></div>
							...
							<div class="col-sm-8">
								...
								<?php
									...
									for($i=0; $i<21; $i++){
										...
										<tr>
											<td>
												<input type="hidden" name="hs_file_delete_topic[]" value="" />
												<input type="hidden" name="hs_file_old_topic[]" value="<?=$hs_file[$i]?>" />
												<span class='help-block col-xs-12'><b><?=$file_num_topic+1?>. 링크URL</b> <input type='checkbox' name='hs_file_delete_topic_chk[]' value="del" /> 삭제</span>
							...
							<div class="col-sm-8">
								...
								<?php
									...
									for($i=0; $i<10; $i++){
										...
										<tr>
											<td>
												<input type="hidden" name="hs_file_delete[]" value="" />
												<input type="hidden" name="hs_file_old[]" value="<?=$hs_file[$i]?>" />
												<span class='help-block col-xs-8'><b><?=$file_num+1?>. 링크URL</b> <input type='checkbox' name='hs_file_delete_chk[]' value="del" /> 삭제</span>
												<input type='text' placeholder='순서(0~9)' class='col-xs-4' name='hs_file_sort[]' maxlength='1' value='<?=$hs_file_sort[$i]?>'>
					...
					<div id="custom_sns" <?php if{?>style="display:none;"<?php }?>>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" placeholder="예: https://www.facebook.com/facebook" class="col-xs-12 col-sm-12" name="hs_sns_url" maxlength="255" value="<?=$hs_sns_url?>">
							</div>
						</div>
						<div class="space-4"></div>
					</div>
...
<script type="text/javascript">
	...
	var flen_topic = <?=$file_num_topic?>;
	parent.document.getElementById("bannerFrame").height = (parent.document.getElementById("bannerFrame").height * 1)+ (280*flen_topic);
	...
	function check_form() {
		...
		if (document.getElementById('custom_image').style.display != "none"){
			for(var a=0; a < flen; a++){
				if(document.getElementsByName('hs_file_delete_chk[]')[a] && document.getElementsByName('hs_file_delete_chk[]')[a].checked == true){
					document.getElementsByName('hs_file_delete[]')[a].value = "del";	
				}
...
// 					return;
// 				}
				if (document.getElementsByName('hs_file[]')[a].value == "" && !document.getElementsByName('hs_file_old[]')[a]){
		...
		if (document.getElementById('custom_topic').style.display != "none"){
			...
			for(var a=0; a < flen_topic; a++){
				if(document.getElementsByName('hs_file_delete_topic_chk[]')[a] && document.getElementsByName('hs_file_delete_topic_chk[]')[a].checked == true){
					document.getElementsByName('hs_file_delete_topic[]')[a].value = "del";	
				}
...
// 				}
				...
				if(a < 7){
					...
					if(topic == "image"){
						if (document.getElementsByName('hs_file_topic[]')[a].value == "" && !document.getElementsByName('hs_file_old_topic[]')[a]){
