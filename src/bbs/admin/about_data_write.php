...
<div class="page-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="ad_form" name="ad_form" action="<?=$iw['admin_path']?>/about_data_write_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post" enctype="multipart/form-data">
				<input type="hidden" name="ad_code" value="<?=$ad_code?>" />
					<div class="form-group">
						<label class="col-sm-1 control-label">네비게이션</label>
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="ad_navigation" maxlength="100">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="ad_subject" maxlength="100">
						</div>
					</div>
					<div class="space-4"></div>
