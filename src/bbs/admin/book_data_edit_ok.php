...
$bd_image = trim(mysqli_real_escape_string($iw['connect'], $_POST['bd_image']));
$bd_subject = trim(mysqli_real_escape_string($iw['connect'], $_POST['bd_subject']));
$bd_author = trim(mysqli_real_escape_string($iw['connect'], $_POST['bd_author']));
$bd_publisher = trim(mysqli_real_escape_string($iw['connect'], $_POST['bd_publisher']));
$bd_price = trim(mysqli_real_escape_string($iw['connect'], $_POST['bd_price']));
$bd_tag = trim(mysqli_real_escape_string($iw['connect'], $_POST['bd_tag']));
$bd_content = mysqli_real_escape_string($iw['connect'], $_POST['contents1']);
$bd_image_old = trim(mysqli_real_escape_string($iw['connect'], $_POST['bd_image_old']));
