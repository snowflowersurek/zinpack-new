...
<div class="page-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="mb_form" name="mb_form" action="<?=$iw['admin_path']?>/member_data_edit_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post">
				<input type="hidden" name="mb_code" value="<?=$mb_code?>" />
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							...
							<button class="btn btn-default" type="button" onclick="location='<?=$iw['admin_path']?>/member_data_view.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>&idx=<?=$mb_code?>'">
