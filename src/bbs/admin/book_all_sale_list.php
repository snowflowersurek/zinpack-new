						...
						<section class="content-box">
							...
							<div class="table-set-mobile dataTable-wrapper">
								...
								<table class="table table-striped table-bordered table-hover dataTable">
									...
									<tbody>
									<?
										$sql = "select * from $iw[book_buy_table] where ep_code = '$iw[store]' and gp_code = '$iw[group]' $search_sql";
										...
										$sql = "select * from $iw[book_buy_table] where ep_code = '$iw[store]' and gp_code = '$iw[group]' $search_sql order by bb_no desc limit $start_line, $end_line";
										$result = sql_query($sql);
									...
									?>
										<tr>
											...
											<td data-title="관리자(point)"><?=$bb_price_site?></td>
											<td data-title="판매자(point)"><?=$bb_price_seller?></td>
