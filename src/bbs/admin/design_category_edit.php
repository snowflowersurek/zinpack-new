...
<div class="page-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="cg_form" name="cg_form" action="<?=$iw['admin_path']?>/design_category_edit_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post" enctype="multipart/form-data">
				<input type="hidden" name="cg_no" value="<?=$cg_no?>" />
					<div class="form-group">
						<label class="col-sm-1 control-label">글쓰기 권한</label>
						<div class="col-sm-11">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">덧글쓰기 권한</label>
						<div class="col-sm-11">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">읽기 권한</label>
						<div class="col-sm-11">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">업로드 권한</label>
						<div class="col-sm-11">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">다운로드 권한</label>
						<div class="col-sm-11">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">기본 정보</label>
						<div class="col-sm-11">
							<label class="middle">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">부가 기능</label>
						<div class="col-sm-11">
							<label class="middle">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label">SNS 공유</label>
						<div class="col-sm-11">
							<label class="middle">
