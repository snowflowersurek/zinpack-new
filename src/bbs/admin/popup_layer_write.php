...
<div class="page-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="pl_form" name="pl_form" action="<?=$iw['admin_path']?>/popup_layer_write_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-1 control-label">기간</label>
						<div class="col-sm-11">
							<input type="text" id="sc_reserve_date1" name="pl_stime" size="10" value="<?echo date("Y-m-d");?>" readonly> ~ 
							<input type="text" id="sc_reserve_date2" name="pl_etime" size="10" value="<?echo date("Y-m-d");?>" readonly> 까지 (ex 2013-02-02)
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="pl_subject" maxlength="100">
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-11">
							<textarea class="ckeditor" width="100%" id="contents1" name="contents1" rows="10"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							가로 <input type="text" placeholder="입력" name="pl_width" size="6" maxlength="4"> px &nbsp; 
							세로 <input type="text" placeholder="입력" name="pl_height" size="6" maxlength="4"> px
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							위에서 <input type="text" placeholder="입력" name="pl_top" size="6" maxlength="4"> px &nbsp; 
							왼쪽에서 <input type="text" placeholder="입력" name="pl_left" size="6" maxlength="4"> px
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
							<input class="form-tooltip col-xs-10 col-sm-5" type="text" placeholder="#ffffff" data-toggle="tooltip" name="pl_dayback" maxlength="7" value="#ffffff"> 
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
							<input class="form-tooltip col-xs-10 col-sm-5" type="text" placeholder="#ffffff" data-toggle="tooltip" name="pl_dayfont" maxlength="7" value="#000000"> 
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3 bootstrap-colorpicker colorpicker-element" data-colorpicker-guid="1">
							<input class="form-tooltip col-xs-10 col-sm-5" type="text" placeholder="#ffffff" data-toggle="tooltip" name="pl_line" maxlength="7" value="#ffffff">
						</div>
					</div>
					<div class="space-4"></div>
