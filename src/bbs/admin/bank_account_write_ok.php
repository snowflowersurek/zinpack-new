...
<?php
$ac_no = trim(mysqli_real_escape_string($iw['connect'], $_POST['ac_no']));
$ac_holder = trim(mysqli_real_escape_string($iw['connect'], $_POST['ac_holder']));
$ac_bank = trim(mysqli_real_escape_string($iw['connect'], $_POST['ac_bank']));
$ac_number = trim(mysqli_real_escape_string($iw['connect'], $_POST['ac_number']));
