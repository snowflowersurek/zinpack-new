						...
						<section class="content-box">
							...
							<div class="table-set-mobile dataTable-wrapper">
										...
										<div class="dataTable-option-right">
											<?php
												...
												if($search =="a"){
													...
													$search_sql = "and ds_subject like '%$searchs%'";
												}
											?>
								...
								<table class="table table-striped table-bordered table-hover dataTable">
									...
									<tbody>
									<?php
										$sql = "select * from $iw[doc_support_table] where ep_code = '$iw[store]' and gp_code = '$iw[group]' and seller_mb_code='$iw[member]' $search_sql";
										...
										$sql = "select * from $iw[doc_support_table] where ep_code = '$iw[store]' and gp_code = '$iw[group]' and seller_mb_code='$iw[member]' $search_sql order by ds_no desc limit $start_line, $end_line";
										$result = sql_query($sql);

										$i=0;
										while($row = @sql_fetch_array($result)){
											$ds_subject = stripslashes($row["ds_subject"]);
											$dd_code = $row["dd_code"];
											$mb_code = $row["mb_code"];
									...
									?>
										<tr>
											...
											<td data-title="컨텐츠명"><?=$ds_subject?></td>
