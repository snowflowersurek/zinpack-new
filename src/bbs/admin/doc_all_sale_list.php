						...
						<section class="content-box">
							...
							<div class="table-set-mobile dataTable-wrapper">
								...
								<table class="table table-striped table-bordered table-hover dataTable">
									...
									<tbody>
									<?
										$sql = "select * from $iw[doc_buy_table] where ep_code = '$iw[store]' and gp_code = '$iw[group]' $search_sql";
										...
										$sql = "select * from $iw[doc_buy_table] where ep_code = '$iw[store]' and gp_code = '$iw[group]' $search_sql order by db_no desc limit $start_line, $end_line";
										$result = sql_query($sql);
										...
										while($row = @sql_fetch_array($result)){
											...
											$download_btn ="<a href='$iw[m_path]/$iw[type]_data_download.php?type=$iw[type]&ep=$iw[store]&gp=$gp_code&item=$dd_code'>다운</a>";
									...
									?>
										<tr>
											...
											<td data-title="관리자(point)"><?=$db_price_site?></td>
											<td data-title="판매자(point)"><?=$db_price_seller?></td>
									...
									<?
										...
										if($i==0) echo "<tr><td colspan='8' align='center'>판매내역이 없습니다.</td></tr>";
									?>
									</tbody>
								</table>
								<div class="row">
