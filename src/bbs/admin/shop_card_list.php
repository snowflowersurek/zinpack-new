						...
						<section class="content-box">
							...
							<div class="table-set-mobile dataTable-wrapper">
									...
									<div class="col-sm-6">
										<div class="dataTable-option-right">
											<?
												...
												if($search =="a"){
													$search_sql = "and lgd_oid like '%$searchs%'";
												}else if($search =="b"){
													$search_sql = "and lgd_financeauthnum like '%$searchs%'";
												}else if($search =="c"){
													$search_sql = "and lgd_buyer like '%$searchs%'";
												}
											?>
								...
								<table class="table table-striped table-bordered table-hover dataTable">
									...
									<tbody>
									<?
										$sql = "select * from $iw[lgd_table] where ep_code = '$iw[store]' and state_sort = '$iw[type]' $search_sql";
										...
										$sql = "select * from $iw[lgd_table] where ep_code = '$iw[store]' and state_sort = '$iw[type]' $search_sql order by lgd_no desc limit $start_line, $end_line";
										$result = sql_query($sql);
										...
										while($row = @sql_fetch_array($result)){
											...
											$lgd_financeauthnum = $row["lgd_financeauthnum"];
									...
									?>
										<tr>
											...
											<td data-title="승인금액"><?=$lgd_amount?> 원</td>
											<td data-title="입금액"><?if($lgd_paytype=="SC0040"){?><?=$lgd_castamount?> 원<?}?></td>
									...
									<?
										...
										if($i==0) echo "<tr><td colspan='8' align='center'>LGU+결제내역이 없습니다.</td></tr>";
									?>
									</tbody>
								</table>
								<div class="row">
