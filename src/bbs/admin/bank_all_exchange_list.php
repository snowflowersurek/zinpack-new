...
if ($iw[type] != "bank" || $iw[level] != "admin" || $iw[group] != "all") alert("잘못된 접근입니다!","");
						...
						<section class="content-box">
							...
							<div class="table-set-mobile dataTable-wrapper">
								...
								<table class="table table-striped table-bordered table-hover dataTable">
									...
									<tbody>
									<?php
										$sql = "select * from $iw[exchange_table] where ep_code = '$iw[store]' $search_sql";
										...
										$sql = "select * from $iw[exchange_table] where ep_code = '$iw[store]' $search_sql order by ec_no desc limit $start_line, $end_line";
										$result = sql_query($sql);
									...
									?>
										<tr>
											...
											<td data-title="지급일"><?php if{?><?=$ec_give_datetime }?></td>
										</tr>
									<?php
										$i++;
										}
										if($i==0) echo "<tr><td colspan='9' align='center'>환전내역이 없습니다.</td></tr>";
									?>
									</tbody>
								</table>
								<div class="row">
