...
<div class="page-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="bd_form" name="bd_form" action="<?=$iw['admin_path']?>/book_data_write_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="upload_path" value="<?=$upload_path?>" />
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<select class="col-xs-12 col-sm-8" name="bd_type">
								<option value="">선택</option>
								<option value="1">PDF</option>
								<option value="2">미디어</option>
								<option value="3">블로그</option>
								<option value="4">논문</option>
							</select>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="bd_subject" maxlength="100">
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="bd_author" maxlength="100">
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="bd_publisher" maxlength="100">
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="bd_tag" maxlength="100">
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" name="bd_price" maxlength="10"> Point
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="file" class="col-xs-12 col-sm-8" name="bd_image">
...
<script type="text/javascript">
	function check_form() {
		...
		if (bd_form.bd_type.value == ""){
			alert("스타일을 선택하여 주십시오.");
			bd_form.bd_type.focus();
			return;
		}
		...
		if (bd_form.bd_image.value == "") {
			alert('표지를 첨부하여 주십시오.');
			bd_form.bd_image.focus();
			return;
		}
		if (!bd_form.bd_image.value.match(/(.png|.PNG|.jpg|.JPG|.jpeg|.JPEG|.gif|.GIF)/)) { 
