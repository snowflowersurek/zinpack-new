...
$sql = "select * from $iw[doc_data_table] where ep_code = '$iw[store]' and dd_code = '$dd_code'";
$row = sql_fetch($sql);
			...
			<!-- PAGE CONTENT BEGINS -->
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						<button class="btn btn-default" type="button" onclick="location='<?=$iw['admin_path']?>/doc_all_list.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>'">
