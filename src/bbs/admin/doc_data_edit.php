...
<div class="page-content">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" id="dd_form" name="dd_form" action="<?=$iw['admin_path']?>/doc_data_edit_ok.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>" method="post" enctype="multipart/form-data">
				<input type="hidden" name="dd_code" value="<?=$dd_code?>" />
				<input type="hidden" name="upload_path" value="<?=$upload_path?>" />
				<input type="hidden" name="dd_file_old" value="<?=$row["dd_file"]?>" />
				<input type="hidden" name="dd_image_old" value="<?=$row["dd_image"]?>" />
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							...
							<p class="col-xs-12 col-sm-8 form-control-static">
								<a href="javascript:file_download('<?=$iw['admin_path']?>/doc_data_download.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>&idx=<?=$dd_code?>', '<?=urlencode($row[dd_file_name])?>');"><?=$row["dd_file_name"]?></a> ( <?=number_format($row["dd_file_size"]/1024/1000, 1)?> MB )</a>
							</p>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="dd_subject" maxlength="100" value="<?=$dd_subject?>">
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" name="dd_price" maxlength="10" value="<?=$row["dd_price"]?>"> Point
					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" placeholder="입력" class="col-xs-12 col-sm-8" name="dd_tag" maxlength="100" value="<?=$row["dd_tag"]?>">
					...
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-11">
							<textarea class="ckeditor" width="100%" id="contents1" name="contents1" height="300px"><?=$dd_content?></textarea>
						</div>
					</div>
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							...
							<button class="btn btn-default" type="button" onclick="location='<?=$iw['admin_path']?>/doc_data_view.php?type=<?=$iw[type]?>&ep=<?=$iw[store]?>&gp=<?=$iw[group]?>&idx=<?=$dd_code?>'">
