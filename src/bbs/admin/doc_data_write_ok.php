...
$dd_code = trim(sql_real_escape_string($_POST['dd_code']));
$cg_code = trim(sql_real_escape_string($_POST['cg_code']));
$dd_subject = trim(sql_real_escape_string($_POST['dd_subject']));
$dd_amount = trim(sql_real_escape_string($_POST['dd_amount']));
$dd_type = trim(sql_real_escape_string($_POST['dd_type']));
$dd_price = trim(sql_real_escape_string($_POST['dd_price']));
$dd_download = trim(sql_real_escape_string($_POST['dd_download']));
$dd_tag = trim(sql_real_escape_string($_POST['dd_tag']));
$dd_content = sql_real_escape_string($_POST['contents1']);
