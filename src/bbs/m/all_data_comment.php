...
<?php
$cm_code = trim(mysqli_real_escape_string($iw['connect'], $_POST['cm_code']));
$cm_content = mysqli_real_escape_string($iw['connect'], $_POST['cm_content']);
$cm_recomment = trim(mysqli_real_escape_string($iw['connect'], $_POST['cm_recomment']));
$cm_secret = trim(mysqli_real_escape_string($iw['connect'], $_POST['cm_secret']));
