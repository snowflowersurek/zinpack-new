				...
				<div class="box br-theme">
					...
					<div class="content-info">
						<ul class="list-inline">
							...
							<?php if($cg_date==1){?><li><i class="fa fa-calendar"></i> <?=$dd_datetime?></li><?php } ?><?php if($cg_writer==1){?><li><i class="fa fa-user"></i> <?=$mb_nick?></li><?php } ?><?php if($cg_hit==1){?><li><i class="fa fa-eye"></i> <?=$dd_hit?></li><?php } ?><?php if($cg_comment_view==1){?><li><i class="fa fa-comment"></i> <?=$reply_count?></li><?php } ?><?php if($cg_recommend_view==1){?><li><i class="fa fa-thumbs-up"></i> <span id="recommend_board_1"><?=$dd_recommend?></span></li><?php }?>
						</ul>
						<ul class="list-inline">
							<li><strong><?=national_language($iw[language],"a0174","파일분량");?> : </strong><span class="label label-info"><?=$dd_amount if{?><?=national_language($iw[language],"a0167","쪽"); }else if($dd_type==2){?><?=national_language($iw[language],"a0168","분"); }?></span></li>
							<li><strong><?=national_language($iw[language],"a0156","다운로드 유효기간");?> : </strong><span class="label label-info"><?php if{?><?=national_language($iw[language],"a0157","무제한");?><?php }else{?><?=$dd_download?> <?=national_language($iw[language],"a0158","일"); }?></span></li>
							<li><strong><?=national_language($iw[language],"a0151","자료가격");?> : </strong><span class="label label-info"><?php if{?><?=national_language($iw[language],"a0265","무료");?><?php }else{?><?=$dd_price?> Point<?php }?></span></li>
						</ul>
					</div>
					<div class="col-md-6">
