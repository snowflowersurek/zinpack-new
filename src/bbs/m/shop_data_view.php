				...
				<div class="box br-theme">
					...
					<div class="content-info">
						<ul class="list-inline">
							<?php if($cg_hit==1){?><li><i class="fa fa-eye"></i> <?=$sd_hit?></li><?php } ?><?php if($cg_comment_view==1){?><li><i class="fa fa-comment"></i> <?=$reply_count?></li><?php } ?><?php if($cg_recommend_view==1){?><li><i class="fa fa-thumbs-up"></i> <span id="recommend_board_1"><?=$sd_recommend?></span></li><?php }?>
						</ul>
					</div>
			...
			<div class="masonry-item w-full h-full">
				<div class="box br-theme">
					<div class="form-group">
						...
						?>
							<option value="<?=$i?>" <?php if{?>disabled<?php }?>>&nbsp;<?=$so_name?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<?php if{?><?=national_language($iw[language],"a0233","매진");?><?php }else{?><?=number_format($so_amount)?><?=national_language($iw[language],"a0234","개 남음"); }?>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<?=national_money($iw[language], $so_price);?></option>
						<?php
								$i++;
							}
						?>
					...
					<table class="table">
						<tfoot class="text-right">
							<tr>
								...
								<td id="priceTotal"><?php if{?>US$ <?php }?>0<?php if{?>원<?php }?></td>
							</tr>
						</tfoot>
					</table>
