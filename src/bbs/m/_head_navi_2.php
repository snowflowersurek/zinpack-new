...
?>	
		...
		<div id="navbar-region" class="region">
			<div id="main-navbar" class="navbar navbar-default <? if ($st_menu_mobile == 1) echo 'navbar-mobile'; else echo 'zp-top-nav'; ?> ">
				<div class="container">
					...
					<div id="main-navbar-item" class="navbar-collapse collapse cbp-hrmenu">
						<ul class="nav nav-pills <? if ($st_menu_mobile == 0) echo 'navbar-right'; ?>">
						<?
