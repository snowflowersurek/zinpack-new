		...
		<div class="grid-sizer"></div>
				...
				<div class="box br-theme">
					...
					<div class="content-info">
						<ul class="list-inline">
							...
							<?if($cg_date==1){?><li><i class="fa fa-calendar"></i> <?=$bd_datetime?></li><?}?>
							...
							<?if($cg_recommend_view==1){?><li><i class="fa fa-thumbs-up"></i> <span id="recommend_board_1"><?=$bd_recommend?></span></li><?}?>
						</ul>
						<ul class="list-inline">
							...
							<li><strong><?=national_language($iw[language],"a0151","자료가격");?> : </strong><span class="label label-info"><?if($bd_price=="0"){?><?=national_language($iw[language],"a0265","무료");?><?}else{?><?=$bd_price?> Point<?}?></span></li>
						</ul>
					</div>
					<div class="col-md-6">
					<?if($cg_point_btn==1){?>
					...
					<div class="col-md-6">
						<div class="pull-right">
							<?if($cg_level_download == 10 || $iw[mb_level] >= $cg_level_download || $mb_code == $iw[member]){?>
			...
			<div class="masonry-item w-full h-full">
				<div class="box br-theme text-right">
					<?if($cg_recommend_view==1){?><a class="btn btn-theme btn-sm" href="javascript:recommend_click('<?=$iw[type]?>','<?=$iw[store]?>','<?=$iw[group]?>','board','<?=$bd_no?>');" title="추천"><i class="fa fa-thumbs-up fa-lg"></i> <span id="recommend_board_2"><?=$bd_recommend?></span></a><?}?>
