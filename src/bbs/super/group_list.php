								...
								<table class="table table-striped table-bordered table-hover dataTable">
									...
									?>
										<tr>
											...
											<td data-title="그룹코드"><?php echo $gp_code; ?></td>
											<td data-title="그룹이름"><?php echo $gp_subject; ?></td>
											<td data-title="회원수"><?php echo $gp_total; ?></td>
											<td data-title="개설일자"><?php echo $gp_datetime; ?></td>
											<td data-title="가입방식">
												<?php if($gp_type == 0){?>
													가입불가
