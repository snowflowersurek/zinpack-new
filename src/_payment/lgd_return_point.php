...
?>
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="lgd_response_point.php?type=<?=$payment[type]?>&ep=<?=$payment[store]?>&gp=<?=$payment[group]?>">
<?php
...
<?php
	  ...
	  alert("인증에 실패하였습니다.","http://$return_domain/bbs/m/all_point_charge.php?type=$payment[type]&ep=$payment[store]&gp=$payment[group]");
  }
?>
</body>
</html>
