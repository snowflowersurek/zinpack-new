...
include_once("_check_parameter.php");
     ...
     */    
    $LGD_RETURNURL				= "http://www.info-way.co.kr/_payment/lgd_return_$PAYMENT_TYPE.php?type=$payment[type]&ep=$payment[store]&gp=$payment[group]";  
	
    /*
     * ISP 카드결제 연동중 모바일ISP방식(고객세션을 유지하지않는 비동기방식)의 경우, LGD_KVPMISPNOTEURL/LGD_KVPMISPWAPURL/LGD_KVPMISPCANCELURL를 설정하여 주시기 바랍니다. 
     */    
    $LGD_KVPMISPNOTEURL       	= "http://www.info-way.co.kr/_payment/note_url.php";
    $LGD_KVPMISPWAPURL			= "http://www.info-way.co.kr/_payment/mispwapurl.php?LGD_OID=".$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함 
    $LGD_KVPMISPCANCELURL     	= "http://www.info-way.co.kr/_payment/cancel_url.php";
	...
	$payReqMap['LGD_TAXFREEAMOUNT']      = $LGD_TAXFREEAMOUNT;                // 면세
...
<title>LG 유플러스 eCredit서비스 결제</title>
